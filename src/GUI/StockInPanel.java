...
import DB.StockInDB;
import Listeners.StockInListener;
...
public class StockInPanel extends JPanel{
	...
	private static String col[] = {"Code","Description","Quantity"};
	private StockInListener listen;
	...
	public StockInPanel(){
		...
		lblStockCode = new JLabel("Stock In Code", SwingConstants.RIGHT);
		...
		add(btnConfirm).setBounds(103,260,110,25);
		add(btnClear).setBounds(233,260,110,25);
	...
	public static void setCode(){
		try{
			...
			txtStockCode.setText((StockInDB.getInstance().getCount()+1)+"");
